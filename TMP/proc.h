...
struct	pentry	{
	...
	int freq[27];	// keeps count of the number of times a system call is invoked
	int avg[27];	// stores average time taken for each system call for a process
};

int set; //sets counter
